...
fun IncomeHistoryScreen(
    ...
    val getAllIncomeByDate by viewModel.getAllIncomeByDate.collectAsStateWithLifecycle()
    ...
    LazyColumn(
        ...
        items(getAllIncomeByDate, key = { it.id }) { income ->
            ...
            TransactionCardComp(
                ...
                date = formatTimestampToDateTime(income.createdAt),
                onDeleteClick = {
                    viewModel.deleteIncomeTransaction(income.id)
                },
                onEditClick = {
                    /*TODO*/
                }
